...
if (isset($_REQUEST['ok'])) {
    print "<p><font color='green'>Your registration has been successfully received. ";
    ...
    $cols_hidden = array('reg_date', 'last_login', 'last_ip', 'approved', 'enabled');
    ...
    if (isset($_REQUEST['btnVerify'])) {
        ...
        $extra_fields = array('reg_date', $date, 
                              'last_login', $date, 
                              'last_IP', $ip, 
                              'approved', '1', 
                              'enabled', '1');
